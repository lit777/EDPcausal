...
library(truncnorm)
library(dplyr)
sourceCpp("clustering_small.cpp", rebuild=T)
source("function_small.R")
...
print(process)
save(E.final,E,E.y,E.pi,Y1,Y0,Pi1,Pi0,p1,p0, file=paste("out_edp_v1_small",process,".RData",sep=""))
  }, error=function(e){})
}
